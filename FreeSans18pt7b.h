...
const uint8_t FreeSans18pt7bBitmaps[] PROGMEM = {
    ...
    0x38, 0x38, 0xF8, 0xF0, 0xE0, 0x3C, 0x42, 0x81, 0x81, 0x81, 0x81, 0x42, 
    0x3C
    };
    
    // last char ~ is now a degree symbol, last 8 bytes
    // see https://forum.arduino.cc/t/adding-glyphs-to-adafruit-gfx-builtin-font/689424/10
    // original ending values
    //...., ...., ...., ...., ...., 0x38, 0x00, 0xFC, 0x03, 0xFC, 0x1F, 0x3E,
...
const GFXglyph FreeSans18pt7bGlyphs[] PROGMEM = {
    ...
    {4145, 8, 8, 9, 1, -25}};   // 0x7E '~' is now a degree symbol
    // original line
    //{4145, 15, 6, 18, 1, -10}}; // 0x7E '~'

const GFXfont FreeSans18pt7b PROGMEM = {(uint8_t *)FreeSans18pt7bBitmaps,
                                        (GFXglyph *)FreeSans18pt7bGlyphs, 0x20,
                                        0x7E, 42};

// Approx. 4831 bytes (-6 due to the the change)
